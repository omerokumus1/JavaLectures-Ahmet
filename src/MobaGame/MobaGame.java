...
public class MobaGame {
    ...
    public static void initializeHeros( Skill[] skills){
        Hero[] heroes = {
                ...
                new Mage("Tulen", 4200, 700, 150, 30, 100, 100,
    ...
    public static Arcana[] initializeArcanas(){
        Arcana[] arcanas = {
                new MagicalAttackArcana(16),
                new MagicalAttackArcana(13),
                new MagicalAttackArcana(10),
                new PhysicalAttackArcana(15),
                new PhysicalAttackArcana(40),
                new PhysicalAttackArcana(45),
                new PhysicalAttackArcana(35),
        };
